...
const userSchema = new Schema({
    ...
    password: {
        type: String, required: [true, 'Password is required!'], validate: {
            validator: checkMinLength, message: props => `${props.path} required minimum three characters`
        }
    },
    folder:[{
    ...
    verificationhex: { type: String, required: [true, 'Verification hex is required!'] },
